...
print("")
print("\033[1;31m                                  ----------------------")
print("\033[1;31m                                 [ EJECUCION EN PROCESO ]")
print("\033[1;31m                                 [   POR FAVOR ESPERE   ]")
print("\033[1;31m                                  ----------------------")
print("")
time.sleep(5)
print("")
real =raw_input("\033[1;33m          + Ingresa Tu Nick De Binnero: \033[0m")
print("")
print("\033[1;31m                  + INICIANDO EL SISTEMA POR FAVOR ESPERE..........")
time.sleep(4)
print("")
print "\033[1;31m          + Hola Que Tal \033[0m" + real + "\033[1;35m Me Alegra Que Uses Mi Checker :D\033[0m"
time.sleep(3)
print("")
print("\033[1;32m               ACCESO PERMITIDO..!!\033[1;32m")
time.sleep(3)
print("")
...
def usage():
    ...
    print("")
    print("\033[1;31m                          +-------------------------------------+")
    print("                          +\033[1;32m   GENERADOR DE BIN JoeTech Studio   \033[1;31m+")
    print("                          +-------------------------------------+")
    print("")
    print("    +---------------+")
    ...
    print("\033[1;31m")
    print("    +---------------------------+")
    print("    +\033[;32m Creado por JoeTech Studio\033[1;31m +")
    print("    +---------------------------+\033[0m")
    print("")
...
def main(argv):
    ...
    if bin_format is not "":
        ...
        if not bin_list:
            ...
            print("\n             + CREADOR DEL CHECKER JoeTech Studio")
            print("")
